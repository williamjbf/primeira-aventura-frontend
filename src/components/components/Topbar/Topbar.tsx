...
const Topbar : React.FC<TopbarProps> = ({ scrolled }: { scrolled: boolean }) => {
  return (
    <header
      className={`fixed top-0 z-30 bg-gray-900 transition-border duration-300 ${
      ...
      <div className="flex items-center justify-end h-12 px-6 gap-4 max-w-7xl mx-auto">
        <div className="relative w-48">
          <input
            type="search"
            placeholder="Search"
            className="w-full pl-8 pr-3 py-1.5 rounded bg-gray-900 border border-gray-600 focus:outline-none focus:ring-2 focus:ring-green-500"
          />
